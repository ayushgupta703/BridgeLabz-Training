...
- Link: [LeetCode Problems](https://github.com/ayushgupta703/BridgeLabz-Training/tree/core-java-practice/core-java-practice/leet-code-codebase)

**→ 17 December, 2025 :** 

- Solved and submitted basic practice problems in **Programming Elements**.

- Link: [Practice Problems (Programming Elements)](https://github.com/ayushgupta703/BridgeLabz-Training/tree/core-java-practice/core-java-practice/gcr-codebase/programming-elements)

**→ 18 December, 2025 :** 

- Solved and submitted **Level 1 and 2** problems of **Java Fundamentals** in **Programming Elements**.

- Link: [Java Fundamental Problems (Programming Elements)](https://github.com/ayushgupta703/BridgeLabz-Training/tree/core-java-practice/core-java-practice/gcr-codebase/programming-elements)
